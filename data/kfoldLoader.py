...
class MyDataLoader(udata.Dataset):
    ...
    def normalize_audio(self, audio_data):
        ...
        normalized_audio = self.audio_scaler.fit_transform(audio_data)

        normalized_audio = normalized_audio.reshape(original_shape)
    ...
    def __getitem__(self, index: int):
        ...
        audioData = self.normalize_audio(audioData)
        ...
        # print("Shape of the videoData:", videoData.shape)
        # print("Shape of the audioData:", audioData.shape)
        if self.type == "train":
